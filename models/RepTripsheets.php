...
class RepTripsheets extends \yii\db\ActiveRecord
{
    ...
    public function rules()
    {
        return [
            ...
            [['area', 'customer_name', 'customer_town', 'customer_contact', 'visit_date', 'visit_time',], 'required'],
    ...
    public function attributeLabels()
    {
        return [
            ...
            'date' => 'Date',
            'user_id' => 'User ID',
            'area' => 'Province or Area',
            'customer_name' => 'Customer Name',
            'customer_town' => 'City or Town',
            'customer_contact' => 'Contact Person',
            'customer_number' => 'Contact Tel',
